...
"}"));
        ...
        login->setGeometry(QRect(180, 410, 88, 37));
        QFont font5;
...
"}"));
        ...
        background->setGeometry(QRect(21, 22, 408, 531));
        QFont font7;
        font7.setBold(false);
        background->setFont(font7);
        background->setStyleSheet(QString::fromUtf8("QLabel#background{\n"
"border-radius: 10px;\n"
"background: qlineargradient(spread:pad, x1:0, y1:0, x2:1, y2:0, stop:0 rgb(255, 255, 127), stop:1 rgb(85, 170, 255));\n"
"border: 3px solid;\n"
"border-color: #DBD9D9;\n"
"\n"
"}"));
